...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ArchiveEntrant>
 */
class ArchiveEntrantFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'user_id' => rand(1,30),
            'courrier_entrants_id'=> rand(1,30)
