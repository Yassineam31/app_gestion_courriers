...
<head>
    ...
    @vite(['resources/css/dashboard.css','resources/css/footer.css','resources/css/notificationMarkDashboard.css'])
</head>
<body>
<x-app-layout>
    <div class="container ">
        ...
        <div class="dashboard">
          ...
          <div class="G2">
            <a href="{{route('contactSection')}}" class="button membres" style='text-decoration:none;color:black;'>
              ...
              <a href="{{route('notifications.index')}}" class="button notifications link notification-bell" style='text-decoration:none;color:black;'>
    ...
    {{--Footer--}} 
        ...
        @vite('resources/js/notificationMark.js')
</x-app-layout>
</body>
</html>