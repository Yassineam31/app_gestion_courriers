            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <p class="card-text"><span>حالة المراسلة :</span> {{ $archiveSortant->Statut }}</p>
            ...
            <div class="card mt-3">
                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="reference" value="{{ $archiveSortant->Reference }}">
                        <input type="hidden" name="destinataire" value="{{ $archiveSortant->Destinataire }}">
                        <input type="hidden" name="objet" value="{{ $archiveSortant->ObjetCorrespondance }}">
                        <input type="hidden" name="date_envoi" value="{{ $archiveSortant->DateEnvoiAcademie }}">
                        <input type="hidden" name="correspondance_reponse" value="{{ $archiveSortant->CorrespondanceRequiertReponse }}">
                        <input type="hidden" name="repondu" value="{{ $archiveSortant->ReponseRecue }}">
                        <input type="hidden" name="dernier_delai" value="{{ $archiveSortant->DernierDelaiReceptionReponse }}">
                        <input type="hidden" name="statut" value="{{ $archiveSortant->Statut }}">
                        <input type="hidden" name="telechargement" value="{{ $archiveSortant->TelechargementCorrespondance }}">
