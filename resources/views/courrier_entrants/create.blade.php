...
<body >
    <div class="container">
        ...
        <form action="{{route('courrier_entrants.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="numero_inscription" name="NumeroInscriptionAcademie">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="date_inscription" class="form-label">تاريخ التسجيل بالأكاديمية :</label>
                    <input type="date" class="form-control" id="date_inscription" name="DateInscriptionAcademie">
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="numero_envoi" name="NumeroEnvoiEntiteExpeditrice">
                </div>
            </div>
            <div class="row ">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="">
                        ...
                        <input type="date" class="form-control" id="dernier_delai" name="DernierDelaiReponse">
                    </div>
                </div>
            </div>
            <div class="mb-3">
                <label for="sujet" class="form-label">موضوع المراسلة <span style='color:red;'>*</span>:</label>
                <textarea class="form-control" id="sujet" name="SujetCorrespondance" rows="3" style="max-width: 700px;"></textarea>
